    ...
    if collection == "NAIP":
        ...
        with st.spinner("Loading London Boroughs..."):
            ...
            if st.session_state.london_boroughs_over_65_map is None:
                ...
                m = london_boroughs_over_65.explore("total_pop_over_65_years_old", tiles="CartoDB.Positron", cmap="Blues", scheme="Quantiles", legend_title="Population over 65", edgecolor='none')
